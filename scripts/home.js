...
$(document).ready(function () {
	var conf;
	var optionsDate = {weekday: "short", day: "numeric", month: "numeric", year: "2-digit"};
	...
	confRequest.done(function () {
		$.getJSON("http://weapon.labeli.org/events/" + conf.event.id + ".json", function (response) {
			...
			var when = "Du " + start.toLocaleDateString("fr-FR", optionsDate) + " à " + start.toLocaleTimeString("fr-FR", optionsTime) + " au " + end.toLocaleDateString("fr-FR", optionsDate) + " à " + end.toLocaleTimeString("fr-FR", optionsTime);
